...
class HandbookArticleAdapter(private val mContext: Context, private val mArticles: ArrayList<Article>, private val mArticleItemListener: HandbookArticleItemListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
